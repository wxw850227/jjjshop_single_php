<template>
  ...
  <div class="pb50">
    <el-form ref="form" size="small" :model="form" label-width="200px">
      ...
      <el-form-item label="注册赠送 " prop="register_points" :rules="[{required: true,message: ' '}]">
        <el-input v-model="form.register_points" autocomplete="off" class="max-w460"></el-input>
      </el-form-item>
