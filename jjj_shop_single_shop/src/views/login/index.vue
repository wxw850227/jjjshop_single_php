<template>
  <div class="login-bg" :style="'background-image:url(' + bgimg_url + ');'">
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position="left" label-width="0px"
      ...
      <!--登录-->
      <el-form-item>
        <el-button type="primary" style="width:100%;" @click.native.prevent="SubmitFunc"
    ...
    methods: {
      ...
      getData() {
        ...
        IndexApi.base(true)
          .then(res => {
            self.loading = false;
            const { data: { settings: { shop_bg_img, shop_name } }} = res;
      ...
      SubmitFunc(ev) {
        ...
        this.$refs.ruleForm.validate(async valid => {
          if (valid) {
            ...
            /* afterLogin(Params).then(async ()=>{
              await afterLogin(Params);
              _this.$router.push({
                path: '/home'
              })
            }).catch(error => {
