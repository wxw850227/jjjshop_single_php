  ...
  <div class="product-add">
    <el-form size="small" ref="form" :model="form" label-width="100px">
      ...
      <el-form-item size="small" label="" v-if="form.choice == 1">
        <div class="common-level-rail"><el-button size="small" icon="Plus" @click="addClick">添加商品</el-button></div>
        <div class="pb50">
          <el-table size="small" :data="tableData" border>
            <el-table-column label="图片" width="60">
              <template #default="scope">
                <div class="product-info">
                  <div class="pic"><img :width="30" :height="30" v-img-url="scope.row.product_image" /></div>
                </div>
              </template>
            </el-table-column>
