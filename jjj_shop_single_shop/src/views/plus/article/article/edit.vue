<template>
	<div class="product-add pb50" v-loading="loading">
		...
		<el-form size="small" :model="form" ref="form" :rules="rules" label-width="100px">
			...
			<el-form-item label="文章标题" prop="article_title"><el-input v-model="form.article_title" placeholder="请输入文章标题"
					class="max-w460"></el-input></el-form-item>
			<el-form-item label="描述" prop="dec"><el-input v-model="form.dec" placeholder="请输入文章描述"
					class="max-w460"></el-input></el-form-item>
			...
			<el-form-item label="虚拟阅读量"><el-input type="number" v-model="form.virtual_views" placeholder="请输入数字"
					class="max-w460"></el-input></el-form-item>
			...
			<el-form-item label="文章内容">
				<div class="edit_container">
					<Uediter v-if="!loading" :text="form.article_content" :config="ueditor.config" ref="ue"
						@contentChange="contentChangeFunc"></Uediter>
					<!-- <Uediter v-if="!loading" :text="ueditor.text" :config="ueditor.config" ref="ue"></Uediter> -->
				</div>
			</el-form-item>
			<el-form-item label="排序"><el-input type="number" v-model="form.article_sort" placeholder="请输入数字"
					class="max-w460"></el-input></el-form-item>
			<!--提交-->
