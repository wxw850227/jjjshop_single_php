<template>
  <div>
    <div class="common-level-rail"><el-button size="small" type="primary" icon="Plus" @click="addArticle">添加文章</el-button></div>
      ...
      <el-table :data="tableData" style="width: 100%" v-loading="loading">
        ...
        <el-table-column prop="address" label="封面" width="50">
          <template #default="scope">
            <img v-if="scope.row.image" v-img-url="scope.row.image.file_path" :width="30" :height="30" />
          </template>
        </el-table-column>
