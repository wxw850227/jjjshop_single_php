<template>
  <div class="spec-many-type">
    <!--规格属性-->
    <div class="spec-wrap">
      <template v-if="form.model && form.model.spec_many && form.model.spec_many.spec_attr">
...
export default {
  ...
  inject: ['form'],
  created() {
    console.log("我被值行了",this.form.model.spec_many && this.form.model.spec_many.spec_list.length > 0)
    console.log("**********************",this.form.model,"lllll")
    /*获取列表*/
