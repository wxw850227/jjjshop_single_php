        ...
        <div>
          ...
          >
            ...
            <el-table-column prop="name" label="操作" width="250">
              <template #default="scope">
                <el-button @click="addClick(scope.row,'copy')" type="text" v-if="scope.row.path!='/plus'">一键复制</el-button>
                <el-button @click="addClick(scope.row,'child')" type="text" size="small">添加子菜单</el-button>
                <el-button @click="editClick(scope.row)" type="text" size="small">编辑</el-button>
                <el-button @click="deleteClick(scope.row)" type="text" v-if="scope.row.path!='/plus'">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>
