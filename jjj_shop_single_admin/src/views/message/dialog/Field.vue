<template>
  <el-dialog :title="title" v-model="dialogVisible" @close='dialogFormVisible' :close-on-click-modal="false"
    ...
    <div class="common-level-rail">
      <el-button type="primary" @click="addClick">添加字段</el-button>
    </div>
    <el-form size="small">
        ...
        <el-table border :data="fieldData" v-loading="loading">
          <el-table-column label="字段名称" width="120px">
            <template #default="scope">
              <el-input prop="field_name" v-model="scope.row.field_name"></el-input>
            </template>
          </el-table-column>
          <el-table-column label="字段英文名" width="130px">
            <template #default="scope">
              <el-input prop="field_ename" v-model="scope.row.field_ename"></el-input>
            </template>
          </el-table-column>
          <el-table-column label="字段默认值">
            <template #default="scope">
              <el-input prop="filed_value" v-model="scope.row.filed_value"></el-input>
            </template>
          </el-table-column>
          ...
          <el-table-column label="排序" width="70px">
            <template #default="scope">
              <el-input prop="sort" v-model="scope.row.sort"></el-input>
            </template>
          </el-table-column>
